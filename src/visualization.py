...
def create_dashboard():
    ...
    for d_idx, distance in enumerate(distances):
        ...
        ax_aoa.plot(widths, theta_w_d, 'm-d', linewidth=2, label='Weighted')
        ...
        aoa_width_fig = plt.figure(figsize=(6, 4))
        plt.rc('text', usetex=True)
        plt.rc('font', family='serif')
        ...
        plt.plot(widths, theta_w_d, 'm-d', linewidth=2, label='Weighted')
